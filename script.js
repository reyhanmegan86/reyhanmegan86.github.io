...
const COPY = {
  id: {
    ...
    aboutLead:
      "Saya Reyhan Megan Fulvianto, lahir di Depok pada 23 Agustus 2005. Saya merupakan lulusan SMK Yadika 12 Depok jurusan Teknik Komputer dan Jaringan (TKJ) yang memiliki minat tinggi di bidang teknologi, khususnya komputer, jaringan, serta pengembangan website dan desain UI/UX.",
    aboutEducationTitle: "Riwayat Pendidikan",
    aboutEducation1: "SDN Mampang 3 Depok",
    aboutEducation2: "SMP Yadika 12 Depok",
    aboutEducation3: "SMK Yadika 12 Depok - Teknik Komputer dan Jaringan (TKJ)",
    aboutCompetencyTitle: "Keahlian & Kompetensi",
    aboutCompetency1: "Perakitan komputer dari awal serta instalasi dasar.",
    aboutCompetency2: "Memahami hardware: motherboard, processor, RAM, storage, dan perangkat pendukung.",
    aboutCompetency3: "Troubleshooting dasar untuk pengecekan dan perbaikan sederhana.",
    aboutCompetency4: "Dasar jaringan komputer: topologi, IP address, dan koneksi antar perangkat.",
    aboutCompetency5: "Pengembangan website sederhana secara otodidak.",
    aboutCompetency6: "Dasar desain UI/UX secara otodidak.",
    aboutLearningTitle: "Pengalaman Pembelajaran",
    aboutLearning1:
      "Selama menempuh pendidikan di bidang TKJ, saya aktif mempelajari praktik langsung seperti merakit komputer, mengenal dan memahami setiap komponen hardware, serta mempelajari dasar jaringan komputer.",
    aboutLearning2:
      "Selain itu, saya juga mengembangkan kemampuan secara mandiri dalam pembuatan website dan desain UI/UX untuk meningkatkan kesiapan kerja di bidang IT.",
    aboutCharacterTitle: "Karakter & Tujuan",
    aboutCharacter1: "Semangat belajar tinggi, disiplin, dan bertanggung jawab.",
    aboutCharacter2: "Mampu bekerja secara individu maupun dalam tim.",
    aboutCharacter3: "Fokus mengembangkan kemampuan teknologi secara teori dan praktik.",
    aboutCharacter4: "Siap berkontribusi maksimal di dunia kerja, khususnya bidang IT.",
    aboutDesc1:
    ...
    skillTitle1: "Website Development",
    skillDesc1: "Membangun website responsif dengan struktur rapi, fokus performa, dan kemudahan penggunaan.",
    skillTitle2: "Desain UI/UX Dasar",
    skillDesc2: "Merancang tampilan antarmuka yang bersih, nyaman dilihat, dan mudah dipahami pengguna.",
    skillTitle3: "Hardware & Troubleshooting",
    skillDesc3: "Memahami komponen komputer, perakitan dasar, serta penanganan masalah teknis sederhana.",
    skillTitle4: "Jaringan Komputer Dasar",
    skillDesc4: "Memahami topologi jaringan, IP address, dan konektivitas antar perangkat pada jaringan lokal.",
    servicesTitle: "Layanan",
    serviceLinkWebsiteLabel: "Buka halaman Website Development",
    serviceLinkRedesignLabel: "Buka halaman Redesign Website",
    serviceLinkMaintenanceLabel: "Buka halaman Maintenance",
  ...
  en: {
    ...
    aboutTitle: "About Me",
    aboutLead:
      "I am Reyhan Megan Fulvianto, born in Depok on August 23, 2005. I graduated from SMK Yadika 12 Depok, majoring in Computer and Network Engineering (TKJ), with strong interest in technology, especially computers, networking, website development, and UI/UX design.",
    aboutEducationTitle: "Education History",
    aboutEducation1: "SDN Mampang 3 Depok",
    aboutEducation2: "SMP Yadika 12 Depok",
    aboutEducation3: "SMK Yadika 12 Depok - Computer and Network Engineering (TKJ)",
    aboutCompetencyTitle: "Skills & Competencies",
    aboutCompetency1: "Computer assembly from scratch, including basic installation setup.",
    aboutCompetency2: "Understanding computer hardware: motherboard, processor, RAM, storage, and supporting devices.",
    aboutCompetency3: "Basic troubleshooting for simple diagnostics and fixes.",
    aboutCompetency4: "Basic computer networking: topology, IP addressing, and device connectivity.",
    aboutCompetency5: "Self-taught basic website development.",
    aboutCompetency6: "Self-taught foundational UI/UX design.",
    aboutLearningTitle: "Learning Experience",
    aboutLearning1:
      "During my TKJ studies, I actively practiced hands-on work such as assembling computers, understanding hardware components, and learning computer networking fundamentals.",
    aboutLearning2:
      "In addition, I independently developed skills in website creation and UI/UX design to improve my readiness for professional IT work.",
    aboutCharacterTitle: "Character & Goals",
    aboutCharacter1: "High learning motivation, disciplined, and responsible.",
    aboutCharacter2: "Able to work effectively both independently and in teams.",
    aboutCharacter3: "Focused on improving technology skills in both theory and practice.",
    aboutCharacter4: "Ready to contribute optimally in the workplace, especially in IT.",
    ...
    skillTitle1: "Website Development",
    skillDesc1: "Building responsive websites with clean structure, performance focus, and strong usability.",
    skillTitle2: "Basic UI/UX Design",
    skillDesc2: "Designing interfaces that are clean, comfortable to view, and easy for users to understand.",
    skillTitle3: "Hardware & Troubleshooting",
    skillDesc3: "Understanding computer components, basic assembly, and simple technical issue handling.",
    skillTitle4: "Basic Computer Networking",
    skillDesc4: "Understanding network topology, IP addressing, and device connectivity in local networks.",
    servicesTitle: "Services",
    serviceLinkWebsiteLabel: "Open Website Development page",
    serviceLinkRedesignLabel: "Open Redesign Website page",
    serviceLinkMaintenanceLabel: "Open Maintenance page",
